...
// 		}
        ...
        else
        {
            ...
            if (NULL != xmlBase.Parse(pOutBuf))
            {
                ...
                {
                    if (xmlBase.FindElem("audioCompressionType") && ("PCM" == xmlBase.GetData() || "MP3" == xmlBase.GetData() || "AAC" == xmlBase.GetData()))
                    {
                        AfxMessageBox("SDK not support PCM or MP3 or AAC broadcast");
                    }
                }
            }
