...
void CDlgACAlarmInOutCfg::InitDetectorCombox()
{
    ...
    g_StringLanType(szLan, "双鉴探测器", "Dual Technology PIR detector");
    m_cmbDetector.InsertString(nIndex, szLan);
    ...
    g_StringLanType(szLan, "水浸探测器", "water detector");
    m_cmbDetector.InsertString(nIndex, szLan);
    ...
    m_cmbDetector.InsertString(nIndex, szLan);
    m_cmbDetector.SetItemData(nIndex, UNKNOWN);
    nIndex++;
    ...
    g_StringLanType(szLan, "其它探测器", "Other Detector");
    m_cmbDetector.InsertString(nIndex, szLan);
