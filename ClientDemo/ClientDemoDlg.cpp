...
void CClientDemoDlg::ProcAlarmV40(WPARAM wParam, LPARAM lParam)
{
    ...
    case 3://motion detection alarm
        ...
        if (m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struAlarmChannel.dwPicLen > 0 && m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struAlarmChannel.pDataBuff != NULL)
        {
            ...
            sprintf(cFilename, "%s\\%s[%d][%d]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName, iPort, iAChanNum);
...
void CClientDemoDlg::ProcRuleAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(szInfoBuf, "Smart:[%d] DevIP:[%s]DevIPV6[%s]TargetID[%d]RuleID[%d]RuleName[%s]AbsTime[%d]piclen[%d]PicType[%d]RelAlarmPicNum[%d]AlarmID[%d]IvmsChannel[%d]IvmsChannelEx[%d]EventTypeEx[%s]byPicTransType[%d]RECT[X:%.3f][Y:%.3f][H:%.3f][W:%.3f]bySceneID[%d]",
	...
	case ENUM_VCA_EVENT_ENTER_AREA:
		{
			...
			{
                sprintf(szInfoBuf, "%s Point[%d] fX[%f] fY[%f]", szInfoBuf, i, tempPolygon.struPos[i].fX, tempPolygon.struPos[i].fY);
				OutputDebugString(szInfoBuf);
			}
            g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
		}
    ...
    case ENUM_VCA_EVENT_SPACING_CHANGE:
    {
        ...
        sprintf(szInfoBuf, "%s SpacingThreshold[%d] Sensitivity[%d] DetectMode[%d] Duration[%d]",
    ...
    if (struVcaRuleAlarm.byAppendInfoUploadEnabled==1)
    {
        ...
        sprintf(szInfoBuf, "append info:append pic type[%d];append pic len[%d];AppendChannelType[%d] AppendChannel[%d] append UID[%s];append targetSpeed:[%d];append targetDistance:[%d];append alarmType:[%d];append radarChannel:[%d]",
            struAppendInfo.byAppendPicType, struAppendInfo.dwAppendPicLen, struAppendInfo.byAppendChannelType, struAppendInfo.dwAppendChannel, struAppendInfo.byUID, struAppendInfo.dwTargetSpeed, struAppendInfo.dwTargetDistance, struAppendInfo.byAlarmType, struAppendInfo.byRadarChannel);
        g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
...
void CClientDemoDlg::ProcTpsRealtime(WPARAM wParam, LPARAM lParam)
{
    ...
    if (1 == struTpsRealtime.byAddInfoFlag)
    {
        ...
        sprintf(szInfoBuf, "AddInfoFlag [%d] First Car:LatitudeType [%d] Degree[%d] Minute[%d] fSec[%f] LongitudeType [%d] Degree[%d] Minute[%d] fSec[%f], \
                   Last Car:LatitudeType [%d] Degree[%d] Minute[%d] fSec[%f] LongitudeType [%d] Degree[%d] Minute[%d] fSec[%f] sLicense[%s] struTurnDirection:byLine[%d] \
...
void CClientDemoDlg::ProcTfsAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(szInfoBuf, "Tfs Alarm IvmsChan: [%d] RuleID: [%d] RuleName: [%s] AIDType: [%d] dwAIDTypeEx[%d] AbsTime: [%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] DevIP: [%s] Port: [%d] Chan: [%d] SpecificVehicleType: [%d]\
                           LaneNo: [%d] Direction Start: [%0.3f,%0.3f] Stop: [%0.3f,%0.3f] SceneID: [%d] SceneName: [%s] Direction: [%d] PTZ: [%d,%d,%d] IllegalType: [%u] IlleagelDuration: [%d] MonitoringSiteID: [%s]\
                                                      DeviceID: [%s] Licence: [%s] Believe: [%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u]  byCountry: [%d] CRIndex: [%d] Time: [%s] SerialNo: [%d] VehicleAttribute: [%d] PilotSafebelt: [%d] CopilotSafebelt: [%d]\
                                                      PilotSunVisor: [%d] CopilotSunVisor: [%d] PilotCall: [%d] IllegalCode: [%s] VehicleEnterState: [%d] wCountry: [%d] Region: [%d]   State:[%d] ParkingID:[%s] CrossLine:[%d] ParkingSerialNO:[%s]\
            ...
            struTfsAlarm.struPlateInfo.byCountry, struTfsAlarm.struPlateInfo.wCRIndex,
...
void CClientDemoDlg::ProcFaceSnapAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(szInfoBuf, "Face Snap alarm FaceSnapThermometryEnabled[%d] IsAbnomalTemperature[%d] ThermometryUnit[%d] FaceTemperature[%.1f] fAlarmTemperature[%.1f]BrokenNetHttp[%d]Abs[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] flag[%d] %2.2d%2.2d] \
                        Relative[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] FaceID[%d] Smart[%d] AgeGroup[%d] Sex[%d] EyeGlass[%d] \
                       ...
                       Age[%d], AgeDeviation[%d] FacePicQuality[%d] UIDLen[%d] Mask[%d] Smile[%d] \
...
void CClientDemoDlg::ProcFaceSnapMatchAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(szInfoBuf, "Face Snap Match alarm Channel[%d] IvmsChannel[%d] BrokenNetHttp[%d] Abs[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d  diff[%2.2d%2.2d] FaceID[%d] BlockList ID[%d] StorageIP[%s]-StoragePort[%d] Sex[%d] Glasses[%d] Age[%d] FacePicQuality[%d]\
             StayDuration[%0.3f] MatchPicNum[%d] struRegion[%0.3f, %0.3f, %0.3f, %0.3f] PicTransType[%d]  FDID[%s]   PID[%s] FDDesc[\r\n%s\r\n] Similarity[%f]  ThresholdValue[%d]\
...
void CClientDemoDlg::FaceSnapMatchAlarmInfo(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(sInfo, "%s byAgeGroup=%d \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.byAgeGroup);
    ...
    char *tempFDDesc = new char[struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwFDDescriptionLen];
    ...
    char *tempFCAddition = new char[struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwFCAdditionInfoLen];
    if (struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwFCAdditionInfoLen > 0
        && struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.pFCAdditionInfoBuffer != NULL)
    {
        memcpy(tempFCAddition, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.pFCAdditionInfoBuffer, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwFCAdditionInfoLen);
    ...
    sprintf(szInfoBuf, "Face Snap Match alarm Channel[%d] IvmsChannel[%d] BrokenNetHttp[%d] Abs[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d  diff[%2.2d%2.2d] \
                       ...
                       FaceID[%d] BlockList ID[%d] StorageIP[%s]-StoragePort[%d] Sex[%d] Glasses[%d] Age[%d] FacePicQuality[%d]\
                       StayDuration[%0.3f] MatchPicNum[%d] struRegion[%0.3f, %0.3f, %0.3f, %0.3f] PicTransType[%d] Similarity[%f]  ThresholdValue[%d]\
...
void CClientDemoDlg::ProcAccessCardAlarm(WPARAM wParam, LPARAM lParam)
{
 ...
 //   strcpy(szInfoBuf, szLan); 
    ...
    if (struAcsAlarmInfo.byAcsEventInfoExtendV20 == 1)
    {
        ...
        {
            sprintf(szInfoBuf + strlen(szInfoBuf), " temperature[%f]fX[%f]fY[%f]byThermometryUnit[%d]byIsAbnomalTemperature[%d]", struAcsEventInfoExtendV20.fCurrTemperature, \
...
void CClientDemoDlg::ProcITSPlateAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(szInfoBuf, "ITS Plate Alarm PlateInfo PlateType[%d]Color[%d]Bright[%d]LicenseLen[%d]EntireBelieve[%d]Region[%d]Country[%d]  wCRIndex[%d] Area[%d] PlateSize[%d]PlateCategory[%s]License[%s]PlateRect[x-%f y-%f w-%f h-%f] \
...
void CClientDemoDlg::ProcITSParkVehicle(WPARAM wParam, LPARAM lParam)
{
    ...
    for (i = 0; i < 2; i++)
    {
        if (struParkVehicle.struPicInfo[i].dwDataLen > 0 && struParkVehicle.struPicInfo[i].pBuffer != NULL)
        {
            ...
            {
                sprintf(cFilename, "%s\\LocalTimeITSParkVehicle[%s]_%d.txt", cFilename, chTime, i);
            }
            else
            {
...
void CClientDemoDlg::ProcIDInfoAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    if (struIDCardInfo.byIDCardInfoExtend == 1)
    {
        ...
        {
            sprintf(szTriggerTime + strlen(szTriggerTime), " temperature[%f]fX[%f]fY[%f]byThermometryUnit[%d]byIsAbnomalTemperature[%d]", struIDCardInfoExtend.fCurrTemperature, \
...
void CClientDemoDlg::ProThermometryAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    {
        sprintf(szInfoBuf, "%s: Channel:%d,fAlarmRuleTemperature:%f,Abs[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] ,Relative[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d],VisibleChannel:%d, RuleID:%d,TemperatureSuddenChangeCycle:%d; TemperatureSuddenChangeValue:%f;  ToleranceTemperature:%f, AlertFilteringTime:%d, AlarmFilteringTime:%d,ThermometryUnit:%d, PresetNo:%d, RuleTemperature:%.1f, CurrTemperature:%.1f, PTZ Info[Pan:%f, Tilt:%f, Zoom:%f], AlarmLevel:%d, \
    ...
    else if (1 == struThermometryAlarm.byRuleCalibType || 2 == struThermometryAlarm.byRuleCalibType)
    {
        ...
        sprintf(szInfoBuf, "%s: Channel:%d,fAlarmRuleTemperature:%f,Abs[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] ,Relative[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d], RuleID:%d,TemperatureSuddenChangeCycle:%d; TemperatureSuddenChangeValue:%f; ToleranceTemperature:%f, AlertFilteringTime:%d, AlarmFilteringTime:%d,HighestPoint[x:%f, y:%f],ThermometryUnit:%d, PresetNo:%d, RuleTemperature:%.1f, CurrTemperature:%.1f, PTZ Info[Pan:%f, Tilt:%f, Zoom:%f], AlarmLevel:%d, \
...
void CClientDemoDlg::ProThermometryDiffAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    if (0 == struThermometryAlarm.byRuleCalibType)
    {
        sprintf(szInfoBuf, "%s: Channel:%d,VisibleChannel:%d, AlarmID1:%d, ToleranceTemperature:%f, AlarmFilteringTime:%d,AlarmID2:%d, PresetNo:%d, RuleTemperatureDiff:%.1f, CurTemperatureDiff:%.1f, \
...
void CClientDemoDlg::ProcessEventWithJsonData(WPARAM wParam, LPARAM lParam)
{
    ...
    do 
    {
        ...
        else
        {
            ...
            memcpy(content, pCBBuf, dwBufLen + 1);
        }
		// show   
        ...
        dealFileName(file, szFilename, strEventType);
...
void CClientDemoDlg::dealFileName(char* szFile, char* szFilename, string strType)
{
    if (strType != "mixedTargetDetection")//目前只支持混合目标增加名称说明
    {
        return;
    }

    if (szFile == NULL) //增加判空处理
    {
        return;
    }

    string strFilename = szFile;
    char szLan[128 + 1] = { 0 };
    //去除空格
    int index = 0;
    ...
    strncpy(szFilename, szLan, sizeof(szLan)-1);
    return;
}
...
void CClientDemoDlg::ProcAIOPVideo(WPARAM wParam, LPARAM lParam)
{
    ...
    else if (struHead.dwFacePicBuffLen > 0 && struHead.pFacePicBuff != NULL&&struHead.byPictureMode == 1)
    {
    ...
    else if (struHead.dwComparisonPicBuffLen > 0 && struHead.pComparisonPicBuff != NULL&&struHead.byPictureMode == 1)
    {
