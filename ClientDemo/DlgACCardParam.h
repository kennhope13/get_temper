...
#ifdef DEMO_LAN_CN
static char *pCardType[] = { "未知卡", "普通卡", "特殊群体卡", "禁止名单卡", "巡更卡", "胁迫卡", "超级卡", "来宾卡", "解除卡" , "员工卡", "应急卡", "应急管理卡"};
#else
static char *pCardType[] = { "unknow", "normalcard", "accessiblecard", "blocklistcard", "nightwatchcard", "stresscard", "supercard", "guestcard", "removecard", "employeecard", "emergencycard", "emergencymanagementcard"};
#endif
enum AddModeEum{
    SINGEL_ADD = 0,
    BATCH_ADD
